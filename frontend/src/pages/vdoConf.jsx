...
import "../styles/vdoComponent.css";
import server from "../environment";
import { TextField, Button, IconButton, Icon, Badge, prerelease } from "@mui/material";
...
export default function VdoConf() {
    ...
    const getPermissions = async () => {
        ...
        let getUserMediaSuccess = (stream) => {
            try{
                ...
                console.log("No Local Stream Found" , err);
            }
                ...
                socketRef.current.on('user-joined' , (id , clients ) => {
                    clients.forEach((socketListId) => {
                        ...
                        connections[socketListId].onaddStream = (event) => {
                            ...
                            if(videoExists) {
                                console.log("Video Exists Already");
            ...
            <div className={styles.meetVideoContainer}>
                ...
                {showModal ? <div className={styles.chatRoom}>
                    ...
                    <div className={styles.chattingArea}>
                        <TextField value={message} onChange={(e) => setMessage(e.target.value)} id="outlined-basic" label="Enter Your chat message" variant="outlined"></TextField>
                ...
                <div className={styles.buttonContainer}>
                    ...
                    <IconButton onClick={handleAudio} style={{color : "white"}}>
                        {audio === true ? <MicIcon /> : <MicIcon/>}
                    </IconButton>


                    {screenAvailable === true ? 
                    <IconButton onClick={handleScreen} style={{color : "white"}}>
                        {screen === true ? <ScreenShareIcon /> : <ScreenShareIcon/>}
                    </IconButton> : <></>}
